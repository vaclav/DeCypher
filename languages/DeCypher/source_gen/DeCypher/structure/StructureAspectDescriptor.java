...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0a, conceptFqName)) {
      ...
      case 1:
        return new CompiledConceptDescriptor("DeCypher.structure.AvgReturnRetm", "DeCypher.structure.FunctionalReturnTerm", false, new String[]{"DeCypher.structure.FunctionalReturnTerm"}, new String[]{}, new String[]{});
      case 2:
        return new CompiledConceptDescriptor("DeCypher.structure.CollectReturnType", "DeCypher.structure.FunctionalReturnTerm", false, new String[]{"DeCypher.structure.FunctionalReturnTerm"}, new String[]{}, new String[]{});
      case 3:
        return new CompiledConceptDescriptor("DeCypher.structure.CountReturnTerm", "DeCypher.structure.FunctionalReturnTerm", false, new String[]{"DeCypher.structure.FunctionalReturnTerm"}, new String[]{}, new String[]{});
      case 4:
      ...
      case 6:
        return new CompiledConceptDescriptor("DeCypher.structure.FunctionalReturnTerm", "DeCypher.structure.ReturnTerm", false, new String[]{"DeCypher.structure.ReturnTerm", "jetbrains.mps.lang.core.structure.INamedConcept"}, new String[]{}, new String[]{});
      case 7:
      ...
      case 9:
        return new CompiledConceptDescriptor("DeCypher.structure.IDReturnTerm", "DeCypher.structure.ReturnTerm", false, new String[]{"DeCypher.structure.ReturnTerm"}, new String[]{}, new String[]{});
      case 10:
        return new CompiledConceptDescriptor("DeCypher.structure.IdInitialization", "DeCypher.structure.Initialization", false, new String[]{"DeCypher.structure.Initialization"}, new String[]{}, new String[]{});
      case 11:
        return new CompiledConceptDescriptor("DeCypher.structure.IndexInitialization", "DeCypher.structure.Initialization", false, new String[]{"DeCypher.structure.Initialization", "jetbrains.mps.lang.core.structure.INamedConcept"}, new String[]{}, new String[]{});
      case 12:
        return new CompiledConceptDescriptor("DeCypher.structure.IndexLookup", "DeCypher.structure.IndexQoL", false, new String[]{"DeCypher.structure.IndexQoL", "jetbrains.mps.lang.core.structure.INamedConcept"}, new String[]{"value"}, new String[]{});
      case 13:
        return new CompiledConceptDescriptor("DeCypher.structure.IndexQoL", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"}, new String[]{}, new String[]{});
      case 14:
        return new CompiledConceptDescriptor("DeCypher.structure.IndexQuery", "DeCypher.structure.IndexQoL", false, new String[]{"DeCypher.structure.IndexQoL"}, new String[]{"value"}, new String[]{});
      case 15:
        return new CompiledConceptDescriptor("DeCypher.structure.Initialization", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"}, new String[]{}, new String[]{});
      case 16:
        return new CompiledConceptDescriptor("DeCypher.structure.LengthReturnTerm", "DeCypher.structure.FunctionalReturnTerm", false, new String[]{"DeCypher.structure.FunctionalReturnTerm"}, new String[]{}, new String[]{});
      case 17:
        return new CompiledConceptDescriptor("DeCypher.structure.LimitClause", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"}, new String[]{"number"}, new String[]{});
      case 18:
      ...
      case 19:
        return new CompiledConceptDescriptor("DeCypher.structure.MaxReturnTerm", "DeCypher.structure.FunctionalReturnTerm", false, new String[]{"DeCypher.structure.FunctionalReturnTerm"}, new String[]{}, new String[]{});
      case 20:
        return new CompiledConceptDescriptor("DeCypher.structure.MinReturnTerm", "DeCypher.structure.FunctionalReturnTerm", false, new String[]{"DeCypher.structure.FunctionalReturnTerm"}, new String[]{}, new String[]{});
      case 21:
      ...
      case 25:
        return new CompiledConceptDescriptor("DeCypher.structure.NodesReturnTerm", "DeCypher.structure.ReturnTerm", false, new String[]{"DeCypher.structure.ReturnTerm"}, new String[]{}, new String[]{});
      case 26:
      ...
      case 36:
        return new CompiledConceptDescriptor("DeCypher.structure.RelationshipReference", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"}, new String[]{}, new String[]{"relationship"});
      case 37:
      ...
      case 39:
        return new CompiledConceptDescriptor("DeCypher.structure.RelationshipsReturnTerm", "DeCypher.structure.ReturnTerm", false, new String[]{"DeCypher.structure.ReturnTerm"}, new String[]{}, new String[]{});
      case 40:
